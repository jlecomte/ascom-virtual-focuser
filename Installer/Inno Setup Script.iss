...
[Setup]
AppId={{982BBBC6-2D90-4BA6-BA0D-4DDBA9ED676B}
...
SourceDir="C:\Users\Julien\source\repos\ascom-virtual-focuser"
OutputDir="Installer"
...
[Files]
Source: "ASCOM_Driver\bin\Release\ASCOM.DarkSkyGeek.VirtualFocuser.dll"; DestDir: "{app}"

[Run]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.VirtualFocuser.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.VirtualFocuser.dll"""; Flags: runhidden 64bit; Check: IsWin64

[UninstallRun]
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.VirtualFocuser.dll"""; Flags: runhidden 32bit
; This helps to give a clean uninstall
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.DarkSkyGeek.VirtualFocuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.DarkSkyGeek.VirtualFocuser.dll"""; Flags: runhidden 64bit; Check: IsWin64
